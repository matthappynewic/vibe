...
namespace Vibe.Repositories
{
    public class SongsRepository : ISongRepository
    {
        ...
        public SongsRepository()
        {
            ...
            _songs.Add(new Song() { Name = "Marooned", Artist = "Pink Floyd", Album = " ", Length = " " });
            _songs.Add(new Song() { Name = "Nothing else matters", Artist = "Metallica", Album = " ", Length = " " });
            _songs.Add(new Song() { Name = "Turn the page", Artist = "Metallica", Album = " ", Length = " " });
            _songs.Add(new Song() { Name = "Unforgiven", Artist = "Metallica", Album = " ", Length = " " });
        }
